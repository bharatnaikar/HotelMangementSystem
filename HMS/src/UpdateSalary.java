...
public class UpdateSalary extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setBounds(60, 190, 145, 60);
        ...
        jToggleButton2.setBounds(280, 190, 134, 60);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(60, 50, 360, 40);
        ...
        jTextField2.setBounds(60, 130, 360, 40);

        jDesktopPane1.setMaximumSize(new java.awt.Dimension(550, 300));
        getContentPane().add(jDesktopPane1);
        jDesktopPane1.setBounds(0, 0, 620, 390);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
              String esalary = jTextField2.getText();
        ...
        // }
         if(rs.next()==false){
            ...
            smt.executeUpdate("UPDATE employee set esalary =" + esalary + " where eid = " + eid +"");
